...
class ImportFBX(bpy.types.Operator, ImportHelper):
    ...
    reverse_symmetry_rightside_bone_forwarding: BoolProperty(
            name="Reverse Symmetry Rightside Bone Forwarding",
            description="Reverse symmetry rightside bone forwarding direction for Unreal Engine 4.",
            default=False,
            )
...
class FBX_PT_import_armature(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        sub.prop(operator, "reverse_symmetry_rightside_bone_forwarding")
...
class ExportFBX(bpy.types.Operator, ExportHelper):
    ...
    reverse_symmetry_rightside_bone_forwarding: BoolProperty(
            name="Reverse Symmetry Rightside Bone Forwarding",
            description="Reverse symmetry rightside bone forwarding direction for Unreal Engine.",
            default=False,
            )
...
class FBX_PT_export_armature(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(operator, "reverse_symmetry_rightside_bone_forwarding")
